    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "הכל לבית שירותי הנדימן משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '8f80ca36-8e6d-4fab-9a9d-e6fcb156112b',
                    name: data.name || '',
                    email: data.email || '',
